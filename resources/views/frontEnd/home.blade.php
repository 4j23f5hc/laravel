			...
			<div class="row">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="{{url('product/'.$categ->slug)}}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1" data-filter="*">
                     ...
                     {{-- Category View --}}
				@foreach($category as $categ)
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".prod{{$categ->id}}">
						{{$categ->name}}
					</button>
                @endforeach
				</div>
			...
			@foreach($product as $data)
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item prod{{$data->category_id}}">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="{{asset('public/'.$data->image) }}" alt="IMG-PRODUCT">

							<a href="#" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1" id="product-modal_{{$data->id}}">
								Quick View
							</a>
						</div>
                 ...
                 @include('frontEnd.productViewModal')
			@endforeach
